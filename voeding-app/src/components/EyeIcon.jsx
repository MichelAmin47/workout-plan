// Open/closed eye — the calorie counter's reveal toggle. `open` carries the
// state; there is no separate text label anywhere (see Coach.jsx), so this
// icon is the only visible indicator of whether calories are shown.
